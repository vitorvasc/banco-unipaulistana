...
<html>
    <head>
        ...
        <title>Banco Unipaulistana - Meus Planos</title>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="planosContratados.jsp">Meus Planos<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container tela-inicio">
            <h2 class="mensagem-destaque">Confira abaixo os planos de previdência que foram contratados por você.</h2>
            
            <jsp:include page="/PlanosContratados" />
        </div>
    </body>
</html>
