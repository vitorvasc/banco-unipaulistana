 ...
 * @author vvasc
 */
public class PlanosContratados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<th>Data de Aquisição</th>");
            out.println("<th>Tempo Limite (meses)</th>");
            out.println("</thead>");
            out.println("<tbody>");
            for (PlanosDaConta plano : planosDaContaDao.listarPlanosContratados(numeroDaConta)) {
                out.println("<tr><td>" + plano.getNomeDoPlano() + "</td>");
                out.println("<td>" + plano.getDataAquisicao() + "</td>");
